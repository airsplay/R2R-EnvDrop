...
flag="--attn soft --train auglistener 
      --selfTrain
      ...
      --accumulateGrad
      --featdropout 0.4
      --subout max --optim rms --lr 1e-4 --iters 1000000 --maxAction 35"
mkdir -p snap/$name
CUDA_VISIBLE_DEVICES=$1 unbuffer python r2r_src/train.py $flag --name $name 
